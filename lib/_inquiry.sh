...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Canal MAV que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Canal MAV, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Canal MAV\n"
  printf "   [1] Atualizar Canal MAV\n"
  printf "   [2] Deletar Canal MAV\n"
  printf "   [3] Bloquear Canal MAV\n"
  printf "   [4] Desbloquear Canal MAV\n"
  printf "   [5] Alter. dominio Canal MAV\n"
  printf "\n"
  read -p "> " option
